      ...
      //  holder.textViewMinorder.setText(menu.getMinorder());
        ...
        holder.binc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ++i;
                holder.bset.setText(""+i);
                holder.qty.setText(""+i);
            }
        });
        ...
        holder.bcart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if(!updateMode) {
                String[] projection = {com.example.kashishgupta.hungerbite.Util.COL_FID, com.example.kashishgupta.hungerbite.Util.COL_fNAME};
                Cursor cursor = resolver.query(com.example.kashishgupta.hungerbite.Util.USER_URI,projection,null,null,null);

                if(cursor!=null){
int uri= resolver.update(com.example.kashishgupta.hungerbite.Util.USER_URI,  values,com.example.kashishgupta.hungerbite.Util.KEY_USER,new String [] {String.valueOf(menu.getCity())});
                }
                else{
